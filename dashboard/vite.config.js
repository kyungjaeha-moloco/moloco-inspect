...
var SOURCE_WORKSPACE_ROOT = process.env.SOURCE_WORKSPACE_ROOT || '/Users/kyungjae.ha/Documents/Agent-Design-System';
var MSM_WEB = path.resolve(SOURCE_WORKSPACE_ROOT, 'msm-portal/js/msm-portal-web');
var MSM_SRC = path.resolve(MSM_WEB, 'src');
var MSM_NODE_MODULES = path.resolve(MSM_WEB, 'node_modules');
var DESIGN_SYSTEM_SRC = path.resolve(SOURCE_WORKSPACE_ROOT, 'design-system/src');
            ...
            output: {
                manualChunks: function (id) {
                    if (id.endsWith('.css') || !id.includes('node_modules'))
                        return undefined;
                    if (id.includes('@moloco/moloco-cloud-react-ui'))
                        return 'pkg-moloco-ui';
                    if (id.includes('styled-components'))
                        return 'pkg-styled-components';
