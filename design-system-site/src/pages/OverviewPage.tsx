  ...
  return (
    <>
      ...
      <div className="page-header">
        ...
        <a href="https://github.com/kyungjaeha-moloco/moloco-inspect/tree/main/design-system" target="_blank" rel="noreferrer" style={{ display: 'inline-flex', alignItems: 'center', gap: 6, marginTop: 12, fontSize: 14, color: '#346bea', textDecoration: 'none' }}>
