...
export const sampleNodes: CanvasNode[] = [
  ...
  },
  {
    ...
    data: {
      name: '워크스페이스 선택',
      url: 'http://localhost:8000/v1/select-workplace',
      width: 1440,
      height: 900,
    },
  },
...
export const sampleEdges: CanvasEdge[] = [
  ...
  {
    id: 'edge-iframe-login-reset-password',
    source: 'iframe-login',
    target: 'iframe-reset-password',
    type: 'flow',
    data: { label: '비밀번호 찾기' },
  },
  {
    id: 'edge-iframe-login-select-workplace',
    source: 'iframe-login',
