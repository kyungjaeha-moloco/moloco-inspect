...
The auto-progress paradigm shipped 2026-05-19 (Phase 1 + 2 + Phase 3 G6/G7); the DS-missing AI judge + governance queue shipped 2026-05-20 (Plan v3 G1-G6). Detailed design docs are local-only for now.
