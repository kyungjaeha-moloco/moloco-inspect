...
- `preview-kit`
  - preview bootstrap / screenshot / route verify / copy verify / runtime config
- `product-runner`
  - product repo / git worktree / typecheck / build / test / locale diff / local apply fallback
- `product-execution`
  - preview-kit + product-runner를 묶어 product-aware preview policy / execution helper를 제공

를 각각 감싸는 방향으로 정리 중입니다.
...
- [Product Runner Contract](./docs/PRODUCT_RUNNER_CONTRACT.md)
